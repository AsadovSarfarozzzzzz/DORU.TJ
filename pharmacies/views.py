...
# Панель менеджера аптекиfrom django.shortcuts import get_object_or_404, redirect, render
from django.views import generic
from django.contrib.auth.decorators import login_required
from .models import Pharmacy, PharmacyProduct, PharmacyChat, PharmacyChatMessage
from products.models import Product
...
def manager_dashboard(request):
    ...
    total_messages = PharmacyChatMessage.objects.filter(
        chat__pharmacy=pharmacy
    ).count()
